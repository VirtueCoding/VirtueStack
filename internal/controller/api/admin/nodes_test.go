...
func TestListNodes_InvalidStatus(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/nodes?status=invalid_status", nil)
...
func TestListNodes_InvalidLocationID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/nodes?location_id=not-a-uuid", nil)
	w := httptest.NewRecorder()
...
func TestRegisterNode_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/nodes", bytes.NewBufferString("invalid json"))
...
func TestRegisterNode_OmittedStorageBackendPassesValidation(t *testing.T) {
	w := httptest.NewRecorder()
	c, _ := gin.CreateTestContext(w)

	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/nodes", bytes.NewBufferString(`{
	...
	var payload models.NodeCreateRequest
	err := middleware.BindAndValidate(c, &payload)

	require.NoError(t, err)
	assert.Empty(t, payload.StorageBackend)
}
...
func TestGetNode_InvalidID(t *testing.T) {
	...
	for _, invalidID := range tests {
		t.Run(invalidID, func(t *testing.T) {
			req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/nodes/"+invalidID, nil)
			w := httptest.NewRecorder()
...
func TestUpdateNode_InvalidID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPut, "/nodes/not-a-uuid", bytes.NewBufferString(body))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
...
func TestUpdateNode_InvalidGRPCAddress(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPut, "/nodes/00000000-0000-0000-0000-000000000001", bytes.NewBuffer(jsonBody))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
...
func TestDeleteNode_InvalidID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodDelete, "/nodes/invalid-uuid", nil)
	w := httptest.NewRecorder()
...
func TestDrainNode_InvalidID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/nodes/invalid/drain", nil)
	w := httptest.NewRecorder()
...
func TestFailoverNode_InvalidID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/nodes/invalid/failover", nil)
	w := httptest.NewRecorder()
...
func TestUndrainNode_InvalidID(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/nodes/invalid/undrain", nil)
	w := httptest.NewRecorder()

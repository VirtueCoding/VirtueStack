...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vms_plan_id ON vms(plan_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vms_hostname ON vms(hostname);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_nodes_location_id ON nodes(location_id);

...
// ErrWebhookVerification marks invalid webhook input rejected before processing.
var ErrWebhookVerification = errors.New("webhook verification failed")

// IsWebhookVerificationError reports whether err is a webhook verification error.

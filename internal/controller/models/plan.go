...
type Plan struct {
	...
	// Nullable: nil means plan pricing is managed externally (WHMCS/Blesta).
	...
	// Currency is the ISO 4217 currency code for plan pricing.
...
// Price fields are in integer minor units (cents). Nullable prices indicate
// plans managed externally (e.g., WHMCS).

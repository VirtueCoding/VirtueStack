...
DROP POLICY IF EXISTS pre_action_webhooks_admin_access ON pre_action_webhooks;
ALTER TABLE pre_action_webhooks DISABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS system_webhooks_admin_access ON system_webhooks;
ALTER TABLE system_webhooks DISABLE ROW LEVEL SECURITY;

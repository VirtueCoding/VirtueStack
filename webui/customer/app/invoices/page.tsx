...
export default function CustomerInvoicesPage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => invoiceApi.list({ cursor, perPage: 20 }),
  });
    ...
    <div className="min-h-screen bg-background p-6 md:p-8">
      <div className="mx-auto max-w-5xl space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Your billing invoices and receipts</p>
        </div>
        ...
        {meta?.has_more && (
          <div className="flex justify-center">
            <Button variant="outline" onClick={() => setCursor(meta.next_cursor)}>
              Load more
            </Button>
          </div>
        )}

...
func TestPayPalWebhookHandler_MissingVerificationHeaders(t *testing.T) {
	gin.SetMode(gin.TestMode)
	logger := slog.Default()
	...
	c.Request.Header.Set("Paypal-Transmission-Id", "txn-1")
	c.Request.Header.Set("Paypal-Transmission-Sig", "sig-1")

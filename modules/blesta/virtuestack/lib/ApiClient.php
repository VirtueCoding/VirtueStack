...
class VirtueStackApiClient
{
    ...
    {
        return $this->request('DELETE', '/provisioning/vms/' . urlencode($vmId));
    }
    ...
    {
        return $this->request('POST', '/provisioning/vms/' . urlencode($vmId) . '/suspend');
    }
    ...
    {
        return $this->request('POST', '/provisioning/vms/' . urlencode($vmId) . '/unsuspend');
    }
     ...
     * @return array Response data
     */
    public function resizeVM(string $vmId, string $planId): array
    {
        return $this->request(
            'POST',
            '/provisioning/vms/' . urlencode($vmId) . '/resize',
            ['plan_id' => $planId]
        );
    }
    ...
    {
        return $this->request('GET', '/provisioning/vms/' . urlencode($vmId));
    }
    ...
    {
        return $this->request('GET', '/provisioning/vms/' . urlencode($vmId) . '/status');
    }
    ...
    {
        return $this->request('GET', '/provisioning/vms/' . urlencode($vmId) . '/usage');
    }
     ...
     */
    public function powerOperation(string $vmId, string $action): array
    {
        ...
        return $this->request(
            'POST',
            '/provisioning/vms/' . urlencode($vmId) . '/power',
            ['action' => $action]
        );
    }
    ...
    public function resetPassword(string $vmId): array
    {
        return $this->request(
            'POST',
            '/provisioning/vms/' . urlencode($vmId) . '/password/reset'
        );
    }
    ...
    public function setPassword(string $vmId, string $password): array
    {
        return $this->request(
            'POST',
            '/provisioning/vms/' . urlencode($vmId) . '/password',
            ['password' => $password]
        );
    }

...
export const vmApi = {
  ...
  async getVMs(params: { perPage?: number; cursor?: string } = {}): Promise<CursorPaginatedResponse<VM>> {
    ...
    return apiPaginatedGet<CursorPaginatedResponse<VM>>(`/customer/vms${query}`);
  },
...
export const billingApi = {
  ...
  async getTransactions(
    ...
    if (params.cursor) queryParams.set("cursor", params.cursor);
    const query = queryParams.toString() ? `?${queryParams.toString()}` : "";
    return apiPaginatedGet<CursorPaginatedResponse<BillingTransaction>>(
  ...
  async getPayments(
    ...
    if (params.cursor) queryParams.set("cursor", params.cursor);
    const query = queryParams.toString() ? `?${queryParams.toString()}` : "";
    return apiPaginatedGet<CursorPaginatedResponse<BillingPayment>>(
...
export const invoiceApi = {
  async list(
    ...
    if (params.perPage) queryParams.set("per_page", String(params.perPage));
    const query = queryParams.toString() ? `?${queryParams.toString()}` : "";
    return apiPaginatedGet<CursorPaginatedResponse<Invoice>>(

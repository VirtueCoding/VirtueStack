...
func TestLogin_EmailValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/login", bytes.NewBuffer(jsonBody))
			req.Header.Set("Content-Type", "application/json")
			w := httptest.NewRecorder()
...
func TestVerify2FA_InvalidRequestBody(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/verify-2fa", bytes.NewBufferString("invalid json"))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
...
func TestVerify2FA_Validation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/verify-2fa", bytes.NewBuffer(jsonBody))
			req.Header.Set("Content-Type", "application/json")
			w := httptest.NewRecorder()
